...
/// `` strings which the reorderable list resolves at runtime:
/// `` is the moved item's id, ``/`` its new
/// position.
///
/// ```json
/// {
...
class StacReorderToDoAction extends StacAction {
  ...
  /// Id of the moved to-do. Usually ``.
  final Object? id;

  /// User that owns the to-do. Defaults to the signed-in user when null.
  final Object? userId;

  /// Source position of the moved item. Usually ``.
  final Object? fromIndex;

  /// New position of the moved item. Usually ``.
