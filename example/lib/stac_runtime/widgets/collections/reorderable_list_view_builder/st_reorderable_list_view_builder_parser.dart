...
class StReorderableListViewBuilderParser
  ...
  /// action, resolving `` placeholders with the moved item's fields plus
  /// ``, `` and `` before calling the action.
  ...
  /// Deep-copies a JSON tree replacing `` placeholders with values
