...
/// [StReorderableListViewBuilder] (or any Stac list), with ``
/// placeholders resolved from the item's JSON fields â€” including
/// ``, which drives the completed/in-progress styling.
///
/// ```json
/// {
///   "type": "to_do_tile",
///   "id": "",
///   "title": "",
///   "description": "A Stac-powered Flutter application",
///   "serialNumber": "",
///   "completed": "",
...
class StToDoTile extends StacWidget {
  ...
  /// `"true"`/`"false"` (after `` placeholder injection from
